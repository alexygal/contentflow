          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 max-w-xs">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-600 bg-[#1e293b] pl-10 pr-4 py-2.5 text-sm text-white placeholder:text-slate-500 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
              />
            </div>
