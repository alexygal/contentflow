...
const translations = {
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        { q: '¿Realmente escriben mis scripts?', a: 'Sí. Elige un tema, tu tono y plataforma objetivo. Nuestra IA genera un script completo y personalizado en menos de 30 segundos. Aprende de tu contenido pasado para que la voz, estilo y ángulo sean únicamente tuyos. Apruebas o pides revisión antes de grabar.' },
        { q: '¿Cómo encuentran partnerships de marca?', a: 'Nuestra IA analiza tu demografía de audiencia, tasas de engagement, nicho y temas de contenido para identificar marcas ideales. Generamos emails de prospección personalizados para tu aprobación. Tú finalizas la negociación—nosotros gestionamos todo lo anterior.' },
        ...
        { q: '¿Realmente gestionan los emails de partnership?', a: 'Sí. Escribimos los emails de prospección inicial, seguimientos y resúmenes de propuestas—todos personalizados a la marca específica. Revisas cada mensaje antes de ser enviado. Nunca más pierdes una oportunidad.' },
